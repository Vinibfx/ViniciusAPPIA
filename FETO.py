...
st.write("Classificador de saúde fetal")
...
st.write(feto.target_names)

st.subheader('Predição')
st.write(feto.target_names[prediction])
...
st.write('Feto normal') 

if resultado == ('FETO suspeito'): 

st.write('FETO suspeito')  

if resultado == ('FETO patologico'): 

st.write('FETO patologico') 
