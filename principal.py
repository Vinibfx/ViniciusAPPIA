...
f14 = st.number_input('Digite Número de picos no histograma do exame',min_value=0.0,max_valeu=18)
f15 = st.number_input('Digite Número de zeros no histograma do exame',min_value=0.0,max_valeu=10)
