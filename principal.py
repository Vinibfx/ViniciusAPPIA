...
f2 = st.number_input('Digite Número de acelerações',min_value=0, max_value=0.019)
f3 = st.number_input('Digite Número de movimentos fetais ',min_value=0,max_value=0.48)
f4 = st.number_input('Digite Número de Contrações uterinas ',min_value=0, max_value=0.15)
f5 = st.number_input('Digite Número de LDs ',min_value=0, max_value=0.15)
f6 = st.number_input('Digite Número de SDs ',min_value=0, max_value=0.001)
f7 = st.number_input('Digite Número de DPs ',min_value=0, max_value=0.005)
