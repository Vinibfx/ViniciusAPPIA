...
f2 = st.number_input('Número de acelerações por segundo',min_value=0.0,max_value=0.019)
f3 = st.number_input('Número de movimentos fetais por segundo',min_value=0.0,max_value=0.48)
f4 = st.number_input('Número de Contrações uterinas por segundo',min_value=0.0,max_value=0.15)
f5 = st.number_input('Número de LDs por segundo',min_value=0.0,max_value=0.15)
f6 = st.number_input('Número de SDs por segundo',min_value=0.0,max_value=0.001)
f7 = st.number_input('Número de DPs por segundo',min_value=0.0,max_value=0.005)
...
f14 = st.number_input('Número de picos no histograma do exame',min_value=0,max_value=18)
f15 = st.number_input('Número de zeros no histograma do exame',min_value=0,max_value=10)
